          ...
          {tiers.map((tier, tierIdx) => (
            <div
              ...
              className={classNames(
                ...
                "flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-primary xl:p-10"
              )}
            >
              <div>
              ...
              <a
                ...
                className={classNames(
                  tier.mostPopular
                    ...
                    : "text-indigo-600 ring-1 ring-inset ring-primary hover:ring-indigo-300",
